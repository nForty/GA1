...
| --- | --- | --- |
| Lesson | Two-part lesson on command line (part-1) and git (part-2)| [Here](./using-command-line.ipynb) and [Here](./git-and-github.ipynb)|
...
- Paths/Navigating (10 mins)
- Independent Practice (5 mins)
- Editing and Examining Files (15 mins)
